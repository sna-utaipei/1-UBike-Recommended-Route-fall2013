...
<script src="http://www.youbike.com.tw/js/jquery-1.7.1.min.js"></script>
<script>
...
<head>
<link rel="shortcut icon" href="http://www.youbike.com.tw/images/ubike.ico" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />

<title>歡迎光臨YouBike</title>
<link href="http://www.youbike.com.tw/css/home.css" rel="stylesheet" type="text/css" />
<link href="http://www.youbike.com.tw/css/new.css" rel="stylesheet" type="text/css" />
</head>
...
<div id="HEADER">
<div id="UBIKE"><a href="home.php"><img src="http://www.youbike.com.tw/images/ubikelogo.png" width="282" height="112" /></a></div>


 <div id="LINK"  style="Font-Size:12pt">
<a href="http://www.youbike.com.tw/home.php">首頁</a>│<a href="http://www.youbike.com.tw/lost.php">失物招領</a>│<a href="http://www.youbike.com.tw/find_2.php">自行車遺失協尋</a>│<a href="http://www.youbike.com.tw/contact_02.php">問與答</a>│<a href="https://www.youbike.com.tw/user/member_login01.php">登入</a>│<a href="https://www.youbike.com.tw/user/member_regist01.php">註冊</a>│
  <span style="border:1px solid #FFF;position:absolute;overflow:hidden">
  <form name="lanFrm" method="post" action="http://www.youbike.com.tw/info.php">
 ...
 <option value="0" selected="selected">正體中文</option>
   ...
   <ul>
        ...
        <li class="n01">
     <a href="http://www.youbike.com.tw/about.php">
          關於YouBike
    </a>
     </li>
       
   	     <li class="n02">
    <a href="http://www.youbike.com.tw/news.php">
        最新消息
        </a>
    </li>
            <li class="n03">
    <a href="http://www.youbike.com.tw/guide.php">
           使用說明
            </a>
      </li>
             <li class="n07">
     <a href="http://www.youbike.com.tw/info.php" class="nav4">
          租賃站資訊
          </a></li>
              <li class="n05">
     <a href="http://www.youbike.com.tw/download.php">
            下載專區
          </a>
     </li>
...
<div id="MAIN">
  <div id="INFO">
    <ul>
       <li class="blue"><a href="http://www.youbike.com.tw/info.php">租賃站資訊</a></li>
     <li><a href="http://www.youbike.com.tw/info04.php">租賃站點列表</a></li>
    <li ><a href="http://www.youbike.com.tw/info02.php">服務中心資訊</a></li>
...
<script type="text/javascript">
   ...
   function searchLocationsNear(center) {
     ...
     var searchUrl = 'http://www.youbike.com.tw/ccccc.php?lat=' + center.lat() + '&lng=' + center.lng() + '&radius=' + radius+"&mode="+srh_type;
...
<div id="FOOTER">
 ...
 <div id="footer_a"><table align="center"><tr><td><a href="http://www.youbike.com.tw/privacy.php">隱私權政策</a>│<a href="http://www.youbike.com.tw/contact.php">聯絡我們</a>│Copyright 2012 Taiwan GIANT Sales Company 請尊重智慧財產權，勿任意轉載，違者依法必究</td><td><img src="http://www.youbike.com.tw/images/taipei.jpg" height="30"></tr></table></div>
<script type="text/javascript" src="http://www.youbike.com.tw/admin/js/jquery-1.7.1.min.js"></script>
<script>
